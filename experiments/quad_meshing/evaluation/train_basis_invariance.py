...
pretrain_path = os.path.join(base_path, "output/{}/{}/saved_models/{}.pth".format(DATASET, "20240130_0506", "68400"))
...
if train:
    ...
    train_dataset = RetopoCurvatureDataset(dataset_path, split='train', k_eig=k_eig, use_cache=True, op_cache_dir=None, alternate_basis=False)
    train_loader = DataLoader(train_dataset, batch_size=None, shuffle=True)

test_dataset = RetopoCurvatureDataset(dataset_path, split='test', k_eig=k_eig, use_cache=True, op_cache_dir=None, alternate_basis=True)
