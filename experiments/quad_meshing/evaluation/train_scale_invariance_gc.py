...
DATASET = "ICML/scale_invariance_gc"
...
if train:
    ...
    shutil.copy2(os.path.join(base_path, "train_scale_invariance_gc.py"), os.path.join(scripts_path, "train_scale_invariance_gc.py"))
