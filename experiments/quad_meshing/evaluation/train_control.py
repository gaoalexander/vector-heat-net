...
if train:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/control"
else:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/control"
...
if train:
    ...
    shutil.copy2(os.path.join(base_path, "train_control.py"), os.path.join(scripts_path, "train_control.py"))
