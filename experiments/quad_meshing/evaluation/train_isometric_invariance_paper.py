...
if train:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/paper_isometric"
else:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/paper_isometric"
...
if train:
    ...
    shutil.copy2(os.path.join(base_path, "train_isometric_invariance_paper.py"), os.path.join(scripts_path, "train_rotation_invariance.py"))
