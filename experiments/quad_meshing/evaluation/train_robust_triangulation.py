...
DATASET = "ICML/robust_triangulation"
pretrain_path = os.path.join(base_path, "output/{}/{}/saved_models/{}.pth".format(DATASET, "20240128_2255", "12200"))
...
if train:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/robust_triangulation"
else:
    dataset_path = "/home/jovyan/git/vector-diffusion-net/experiments/quad_meshing/data/ICML/robust_triangulation"
...
if train:
    ...
    shutil.copy2(os.path.join(base_path, "train_robust_triangulation.py"), os.path.join(scripts_path, "train_robust_triangulation.py"))
...
# === Create the model
C_in = {'xyz': 3, 'gaussian_curvature': 2, 'principal_curvature': 2, 'hks_plus_principal': 15, 'hks_plus_gaussian': 15, 'hks_grad': 15, 'hks_grad_cograd': 15, 'hks_normalized': 15, 'random': 3}[input_features]  # dimension of input features
