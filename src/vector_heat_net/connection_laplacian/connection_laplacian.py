...
def connection_laplacian(V,F, twins=None, tips=None, return_basis_vectors=True):
    """
    ...
    hE_tangent_vectors, v2he_x, basis_x, basis_y, _ = half_edge_tangent_vectors(V,F,twins,tips,True)
    ...
    for he in range(nF*3):
        ...
        if he_twin == GHOST_HALF_EDGE:
            ...
            vals[he*4:(he+1)*4] = cotan_he, -cotan_he*rot_he, 0.0, cotan_he
    ...
    if return_basis_vectors:
        return Lc, v2he_x, basis_x, basis_y
    else:
        return Lc